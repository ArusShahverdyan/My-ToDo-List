...
export default function SingleTask() {
    ...
    return (
        ...
        <div className={`${styles.taskContainer} ${styles.singleTaskBG}`}>
            <Container >
                    ...
                    <Col xs={12} lg={10}>
                        <Card   >
                            ...
                            {task ? (
                                ...
                                <Card.Body className={`${task.status === 'done' ? styles.statusDone : styles.statusActive}`}>
